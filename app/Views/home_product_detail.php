...
<body>
<?php
    $topCategories = is_array($topCategories ?? null) ? $topCategories : ['all' => 'All Products'];
    ...
    $activeCategory = trim((string) ($activeTopCategory ?? 'all'));
?>
    <nav class="top-categories" aria-label="Main categories">
        <ul class="top-categories-list">
            <?php foreach ($topCategories as $slug => $label): ?>
                <li>
                    <a href="<?= base_url('home?top=' . urlencode($slug === 'all' ? '' : $slug)) ?>" class="top-cat-link <?= $slug === $activeCategory ? 'active' : '' ?>">
                        <?= esc($label) ?>
                    </a>
                </li>
            <?php endforeach; ?>
        ...
        <section class="detail-main">
            ...
            <div class="cta-box">
                <?php if ($isLoggedIn): ?>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <a href="#" onclick="openLoginModal(); return false;" class="btn btn-buy">Sign in to purchase</a>
                <?php endif; ?>
            </div>
        </section>
